...
<div id="listLayout">
	...
	<center>
		...
		<div class="name">
			<p class="firstString">공지사항</p>
			<p class="secondString">편리한 쇼핑몰 이용을 위해 확인해 주세요</p>
		</div>
			<div id="infolist">
			...
			<!-- 관리자일 때 -->
				<c:if test="${member.member_id eq 'Administrator'}">
					<button type="button" class="text" style="float: right;" onClick="location.href='write'">글쓰기</button>
				</c:if>
			</form>				
