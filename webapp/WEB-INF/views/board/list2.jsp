...
<div id="listLayout">
	...
	<center>
		...
		<!-- 공지사항 메인 이미지가 들어가는 문단 -->
		<div class="name">
			<p class="firstString">고객센터</p>
			<p class="secondString">궁금한 점이나 문의사항을 적어주세요</p>
		</div>
			<div id="infolist">
			...
			<br/>
			<table cellpadding="0" cellspacing="0" style="text-align:center;" width="100%" id="listtable">
				<tr height="50">
				...
				<!--	<input type="hidden" id="show" value="${row.show}"/>	 -->
					...
					<tr>
						...
						<td class="list2" style="text-align:left;"><a href="view2?bno=${row.bno}&show=Y">${row.title}</a></td>
			...
			<!-- 검색 조건 뷰 -->
			<form action="board2" class="boardsearch" align="left">
			...
			<!-- 관리자일 때 -->
                <c:if test="${not empty member.member_id}">
                    <button type="button" class="text" style="float: right;" onClick="location.href='write2'">글쓰기</button>
                </c:if>
