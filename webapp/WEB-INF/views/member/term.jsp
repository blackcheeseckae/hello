...
<html lang="ko">
	...
	<body>
		...
		<!-- 회원가입 페이지(이용약관, signup.js) -->
		<section>
			<div>
				<form name="f1rm" id="f1rm">
					<h1 align="center">이용약관 동의</h1>
					<table align="center" id="termtable">
						<tr align="center">
							<td colspan="2">
								<textarea rows="20" cols="90" style="resize: none;" readonly >
제1조(목적)

본 회원약관은 야구웨이브(이하 '갑'라 한다)이 운영하는 인터넷관련 서비스(이하 '서비스'라 한다)를 이용함에 있어 관리자와 이용자(이하 '회원'라 한다)의 권리, 의무 및 책임사항을 규정함을 목적으로 한다.
...
제 1 조 (시행일) 이 약관은 2018년 12월 30일부터 시행한다.  
						...
						<tr>
							<td class="term_btn">
								<input type="button" class="buttons" onclick="chk()" style="cursor: pointer" value="회원가입" />
							</td>
						</tr>
					</table>
				</form>
